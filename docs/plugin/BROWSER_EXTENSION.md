...
The extension is designed to work with Vigil Guard v1.4.0+ workflow:
...
│       ├── QUICK_WIN_FIXES.md      # Bug fixes log
│       └── TEST_INSTRUKCJA.md      # Testing guide
├── plugin_concept.md              # Feasibility study
├── DEVELOPMENT_PLAN.md            # Development roadmap
├── QUICK_START.md                 # Quick start guide
├── INSTRUKCJA_TESTOWANIA.md       # Testing instructions
└── README.md                      # This file
```
