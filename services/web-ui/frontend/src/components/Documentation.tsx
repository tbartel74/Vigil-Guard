      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-40 bg-slate-900/95 backdrop-blur border-b border-slate-800">
        <div className="flex items-center justify-between px-4 py-3">
          <div>
            ...
            <p className="text-xs text-text-secondary">{currentSection?.title}</p>
          </div>
          <button
      ...
      `}>
        <div className="p-6">
          ...
          <div className="mb-8">
            ...
            <p className="text-xs text-text-secondary">Vigil Guard</p>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-slate-800">
            <div className="space-y-2">
              <a
                ...
                className="flex items-center gap-2 px-3 py-2 text-sm text-text-secondary hover:text-white rounded-md hover:bg-slate-800/50 transition-colors"
              >
              ...
              <ReactMarkdown
                ...
                components={{
                  ...
                  blockquote: ({ node, ...props }) => (
                    <blockquote
                      className="border-l-4 border-blue-500/50 bg-blue-500/5 pl-4 pr-4 py-2 my-6 italic text-text-secondary"
                      {...props}
                    />
                  ),
                  table: ({ node, ...props }) => (
